...
class TestTemplate(object):
    def __init__(self, input_directory):
        self.input_directory = input_directory # Will perform the test for all files in input directory
    ...
    def run_test_custom(self, filepath):
        self.start_time = time.time()
        self.sim = SchedulerSimulation(filepath)
